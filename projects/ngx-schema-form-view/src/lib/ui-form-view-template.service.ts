...
@Injectable()
export class UIFormViewTemplateService {
  ...
  protected loadSchemaSchemaformActionsValidatorMappingsBindings(path: string, envValueResolver?: (string) => string): Observable<UIFormViewModel> {
    let formSchema: any = {}
